...
import { createVaultRecord, decryptVaultRecord, deriveVaultKeyMaterial, decryptVaultRecordWithMaterial, VAULT_ITERATIONS } from "../vault.js";
...
assert(await decryptVaultRecordWithMaterial(record, material) === "finnhub-secret-token", "decrypts only inside the worker from session key material");
